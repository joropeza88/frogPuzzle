<template>
  <main class="relative mx-auto flex min-h-screen h-dvh w-full max-w-md flex-col bg-[radial-gradient(circle_at_top,_rgba(16,185,129,0.36),_transparent_30%),linear-gradient(180deg,_#06281f_0%,_#0f172a_58%,_#020617_100%)] px-4 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] text-white">
